...
export class AIOptimizationService {
  ...
  async optimizeLineup(request: OptimizationRequest): Promise<OptimizationResponse> {
    const { data } = await apiClient.post<OptimizationResponse>(this.baseUrl, request);
  ...
  async getRecommendations(teamId: string, type: 'training' | 'tactical' | 'player') {
