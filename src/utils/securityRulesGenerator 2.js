...
exports.generateRulesForUseCase = exports.getRuleTemplates = exports.generateRules = exports.securityRulesGenerator = exports.SecurityRulesGenerator = void 0;
...
service firebase.storage {
  match /b/{bucket}/o {
     ...
     */
    validateRules(firestoreRules, storageRules, config) {
        const errors = [];
        const warnings = [];
        const suggestions = [];
     ...
     */
    generateRulesForUseCase(useCase) {
...
exports.SecurityRulesGenerator = SecurityRulesGenerator;
// Export singleton instance
exports.securityRulesGenerator = new SecurityRulesGenerator();
// Export convenience functions
const generateRules = (config) => exports.securityRulesGenerator.generateRules(config);
exports.generateRules = generateRules;
const getRuleTemplates = () => exports.securityRulesGenerator.getRuleTemplates();
exports.getRuleTemplates = getRuleTemplates;
const generateRulesForUseCase = (useCase) => exports.securityRulesGenerator.generateRulesForUseCase(useCase);
exports.generateRulesForUseCase = generateRulesForUseCase;
