...
class ThumbnailGenerator {
     ...
     */
    generateThumbnail(play, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dataUrl = yield this.renderThumbnail(play, finalOptions);
            // Cache the result
     ...
     * Draw football field
     */
    drawField(width, height, fieldColor) {
        if (!this.ctx)
            return;
        // Field background
     ...
     */
    drawRoutes(routes, width, height, options) {
        if (!this.ctx)
            return;
     ...
     */
    drawRouteArrows(points, width, height, color) {
     ...
     */
    drawPlayers(players, width, height, options) {
        if (!this.ctx)
            return;
     ...
     */
    preloadThumbnails(plays, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const promises = plays.map(play => this.generateThumbnail(play, options).catch(error => {
    ...
    getCacheStats() {
        ...
        const totalMemory = Object.values(this.cache).reduce((total, item) => total + item.dataUrl.length, 0);
        return {
            size,
     ...
     */
    generateCustomThumbnail(play, width, height, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.generateThumbnail(play, Object.assign(Object.assign({}, options), { width,
                height }));
        });
    }
    /**
     ...
     */
    generateBatchThumbnails(plays, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < plays.length; i += batchSize) {
                ...
                const batchPromises = batch.map((play) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        const thumbnail = yield this.generateThumbnail(play, options);
