...
const PRESET_ROUTES = [
  ...
  { id: 'flat', name: 'Flat', points: [{ x: 0, y: 0 }, { x: 40, y: -3 }] },
  { id: 'comeback', name: 'Comeback', points: [{ x: 0, y: 0 }, { x: 5, y: -45 }, { x: 20, y: -38 }] },
  { id: 'curl', name: 'Curl', points: [{ x: 0, y: 0 }, { x: 3, y: -30 }, { x: -5, y: -25 }] },
  { id: 'wheel', name: 'Wheel', points: [{ x: 0, y: 0 }, { x: 30, y: -3 }, { x: 35, y: -15 }, { x: 35, y: -50 }] },
  { id: 'screen', name: 'Screen', points: [{ x: 0, y: 0 }, { x: -10, y: 5 }, { x: 20, y: 5 }] }
];
