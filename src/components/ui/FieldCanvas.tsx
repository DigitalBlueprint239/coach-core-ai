...
interface FieldCanvasProps {
  ...
  onPlayerMove?: (playerId: string, position: Point) => void;
  onZoom?: (scale: number) => void;
  onPan?: (offset: Point) => void;
  initialScale?: number;
  maxScale?: number;
  minScale?: number;
  enableTouchDrawing?: boolean;
...
export const FieldCanvas: React.FC<FieldCanvasProps> = ({
  ...
  const touchStatesRef = useRef<Map<number, TouchState>>(new Map());
  ...
  return (
    <div
      ref={containerRef}
      className={`field-canvas-container ${className}`}
      style={{
        position: 'relative',
        width,
        height,
    ...
    >
      ...
      {contextMenu.visible && (
        ...
        >
          <TouchableOpacity
            onPress={() => handleContextMenuAction('add-player')}
          ...
          <TouchableOpacity
            onPress={() => handleContextMenuAction('add-route')}
            className="context-menu-item"
            style={{ padding: '8px 16px', fontSize: '14px' }}
          >
            Add Route
          ...
          <TouchableOpacity
            ...
            className="context-menu-item"
            style={{ padding: '8px 16px', fontSize: '14px', color: '#E74C3C' }}
          >
            Delete
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => handleContextMenuAction('properties')}
            className="context-menu-item"
            style={{ padding: '8px 16px', fontSize: '14px' }}
          >
            Properties
