...
> {
  ...
  private classifyDataError(
    error: Error
  ): 'permission' | 'validation' | 'network' | 'firebase' | 'unknown' {
  ...
  render(): ReactNode {
    ...
    const { dataStatus, dataSource, permissionLevel, lastDataSync } =
      this.state;
          ...
          <div className="data-loading-error-container">
            ...
            <div className="data-loading-status">
              <div className="status-grid">
                ...
                <div className="status-item">
                  ...
                  <span className={`status-value ${dataStatus}`}>
                    {dataStatus}
                  </span>
                </div>
                <div className="status-item">
            ...
            {permissionLevel === 'none' && (
              <div className="permission-info">
                ...
                <p>
                  You need appropriate permissions to access this data. Contact
                  your team administrator or coach to request access.
                </p>
                <div className="permission-levels">
                  ...
                  <div className="permission-level">
                    <strong>Write Access:</strong> Edit team information and
                    create content
                  </div>
                  <div className="permission-level">
                    <strong>Admin Access:</strong> Full team management
                    capabilities
                  </div>
                </div>
              </div>
